## Scope
This repo contains various operational cloud engineering tasks inside of GCP. It is being used to prepare for both the CDL and the ACE. Additionally, it will be greatly expanded for a Terraform infra project I have mapped out I will be starting later in 2025.
...
- 2025-07-20 Access the Management Services then the API service  
...
- 2025-07-20 Export both the PROJECT and ZONE paramaters to their respective variables, then echo the output for each to CloudShell    
...
- 2025-07-26 Create an RSA keypair for the most recently created VM, assign to the active zone, then validate SSH functionality using CloudShell  
...
- 2025-07-26 Update the OS, install NGINX, and confirming running on the VM  
...
- 2025-07-26 View the past seven days of spend, as well as the projected spend forecast in the billing account overview
  ![BAS1](Billing_and_Spend/BAS1.png)
...
- 2025-07-27 Validate the app is accesible from a browser  
  ![AAE3](APIs_and_AppEngine/AAE3.png)
- 2025-07-27 Start the web server, validate the accesibility, then stop the server  
...
- 2025-07-27 Deploy the web application to the App Engine service  
  ![AAE7](APIs_and_AppEngine/AAE7.png)
...
- 2025-07-27 Deploying the image to CloudBuild  
  ![CR1-9](CloudRun/CR1-9.png)
- 2025-07-27 Validate the deployment is running  
  ![CR1-10](CloudRun/CR1-10.png)
- 2025-07-27 Reploy the app with a concurrency of 1, as opposed to the default concurrency of 80  
...
- 2025-07-27 Build an update to the website by updating and pushing the Docker image(s) being used for this task  
  ![CR1-14](CloudRun/CR1-14.png)
- 2025-07-27 Update and then validate the website with zero downtime for endusers  
...
- 2025-07-27 - Create kubernetes service -> expose the app to external traffic -> validate services are running -> confirm the externalIP has been generated via CloudShell  
